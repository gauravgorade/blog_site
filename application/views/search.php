        ...
        <div class="options_layout_container full_layout_enable_front">
            ...
            <div class="main_title_wrapper category_title_section jl_cat_img_bg">
                <div class="category_image_bg_image"
                    style="background-image: url('<?php echo base_url()?>web/theme/disto/demo/wp-content/uploads/2019/02/roberto-nickson-1299738-unsplash-780x520.jpg');">
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 main_title_col">
                                <div class="jl_cat_mid_title">
                                    <h3 class="categories-title title">Search Result
                                    </h3>
                        ...
                        <div class="col-md-8 grid-sidebar" id="content">
                            <div class="row">
                                ...
                                <div class="box blog_grid_post_style  jl_row_1">
                                    <h3 class="categories-title title">No Match Found
                                    </h3>
                                    <p>Search by blog name and description or look for in categories</p>
                                    ...
                                    <div class="jl_grid_box_wrapper">
                                        <div class="image-post-thumb">
                                            <a href="<?php echo base_url()."blog/".$blog_url?>"
                                                class="link_image featured-thumbnail" title="<?php echo $blogname; ?>">
                                                <img width="780" height="450" style="max-height:200px; min-height:200px"
                                        ...
                                        <div class="post-entry-content">
                                            ...
                                            <div class="content_post_grid">
                                                <p style="color:#6b34ba"><?php echo substr($short_info,0,140); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="slider_widget_post jelly_loading_pro">
                                    ...
                                    <div class="recent_post_large_widget"> <span class="image_grid_header_absolute"
                                        ...
                                        <span class="meta-category-small">
                                            <?php  $_cat = $this->db->query("SELECT * FROM `blog_category` WHERE  b_cat_id =$blog_idd ");
