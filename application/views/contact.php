        ...
        <div class="options_layout_container full_layout_enable_front">
            ...
            <div class="main_title_wrapper category_title_section jl_cat_img_bg">
                <div class="category_image_bg_image"
                    style="background-image: url('<?php echo base_url()?>web/theme/disto/demo/wp-content/uploads/2019/02/ashley-knedler-90856-unsplash-1000x662.jpg');">
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-8 grid-sidebar" id="content">
                            <div class="jl_wrapper_cat">
                                ...
                                <div id="respond" class="comment-respond" style="background-color:white">
                                    <h3 id="reply-title" class="comment-reply-title">Fill in the contact form below to
                                        share your message and your contact
                                        details with us..<small><a rel="nofollow" id="cancel-comment-reply-link"
                                                href="#" style="display:none;"></a></small></h3>
                                    <form action="<?php echo base_url()?>home/contact_inquiry" method="post"
                                        id="commentform" class="comment-form row g-3 needs-validation" novalidate>
                                        ...
                                        <div class="form-fields row">
                                            ...
                                            <span class="comment-form-author col-md-5 m-3"><input id="author"
                                                    name="name" type="text" value="" size="30" placeholder="Fullname"
                                                    required class="form-control"></span>


                                            <span class="comment-form-email col-md-5 m-3"><input id="phone" name="phone"
                                                    type="text" value="" size="30" placeholder="Mobile No"
                                                    onkeyup="if(!$.isNumeric(this.value)){this.value = this.value.slice(0,-1);}"
                                                    pattern="[0-9]+" maxlength="10" minlength="10"
                                                    class="form-control"></span>


                                            <span class="comment-form-author col-md-8 m-3"><input id="email"
                                                    name="email" type="email" value="" size="30" placeholder="Email"
                                                    required class="form-control"></span>

                                            <span class="comment-form-author col-md-12 m-3"><input id="subject"
                                                    name="subject" type="text" value="" size="30" placeholder="Subject"
                                                    class="form-control"></span>

                                            <span class="comment-form-author col-md-12 m-3"><input id="message" required
                                                    name="message" type="text" value="" size="30" placeholder="Message"
                                                    class="form-control"></span>
