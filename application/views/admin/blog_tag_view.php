                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">
                                        <a href="<?php echo base_url();?>admin/blog/view_tag">View  Blog
                                            tags</a>
                                    </li>
                                </ol>
                            </nav>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title">Add  Blog Tag</h6>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <textarea name="cat_desc" id="cat_desc" class="form-control"
                                                        required> <?php echo set_value('cat_desc'); ?></textarea>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <h6 class="card-title"> Blog Tags</h6>
                                    	    ...
                                    	    ?>
                                                        <tr>
                                                            ...
                                                            <th width="8%" class="text-center"><a
                                                                    href="<?php echo base_url()."admin/blog_tag/edit/".$t_id;?>"
