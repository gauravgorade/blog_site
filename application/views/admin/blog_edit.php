                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo base_url();?>admin/blog/view_blog">  Blog View</a>
                                    </li>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-control custom-switch">
                                                            <input name="featured" type="checkbox"
                                                                class="custom-control-input" id="customSwitch1" <?php if ($featured=='on') 
                                            { 	echo 'checked'; 	} else {    } ?>>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <img id="prelg_profile"
                                                                src="<?php echo base_url()."assets/img/blog/".$img_path2;?>"
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    ...
                                                    <img src="<?php echo base_url()."assets/img/blog/".$img_path;?>"
