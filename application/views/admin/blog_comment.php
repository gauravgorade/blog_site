										...
										<td> <?php echo substr($row->email,0, 10);?> </td> 
                                         ...
                                         <th class="text-center">  
                                              ...
                                              <a title="View Details"
                                                                    href="<?php echo base_url()."admin/blog/comment_view/".$t_id."/".$blog_id;?>"
                                                                    class="btn btn-primary btn-floating btn-sm">
                                                                    <i class="ti-view-list"></i></a>

                                                                    <a href="<?php echo base_url()."admin/blog/comment_edit/".$t_id."/".$blog_id;?>" class="btn btn-info btn-floating btn-sm">
  									    ...
  									    <td class="text-center">
                                            ...
                                            <span class="btn btn-secondary btn-sm">  Under <br> Observation </span></a>  
                   							<?php } else {?>
