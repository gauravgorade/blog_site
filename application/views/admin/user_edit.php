                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div data-label="Contact information" class="demo-code-preview row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <label for="admin_type">Admin Role</label>
                                                    <select name="admin_type" id="admin_type" required
                                                        class="form-control" required>
                                                        <option value="">Select</option>
                                                        <option <?php if($row->admin_type == "1"){ echo 'selected';}?> value="1">Super Admin</option>
                                                        <option <?php if($row->admin_type == "2"){ echo 'selected';}?> value="2">ABD Admin</option>
                                                        <option <?php if($row->admin_type == "3"){ echo 'selected';}?> value="3">BEED Admin</option>
                                                        <option <?php if($row->admin_type == "4"){ echo 'selected';}?> value="4">ABD Staff</option>
                                                        <option <?php if($row->admin_type == "5"){ echo 'selected';}?> value="5">BEED Staff</option>
